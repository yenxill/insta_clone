function updateInputState(input,activeVar) {
  ...
  function handleInput(e) {
    ...
    if(type == "text") {
        usernameActive = updateInputState(input, usernameActive);
    } else {
        usernicknameActive = updateInputState(input, usernicknameActive);
    }
    ...
    if(usernameActive && usernicknameActive) {
        submitBtn.removeAttribute('disabled');
    } else {
        submitBtn.setAttribute('disabled', true);
    }
  ...
  usernameActive.addEventListener('keyup', handleInput);
  usernicknameActive.addEventListener('keyup', handleInput);
